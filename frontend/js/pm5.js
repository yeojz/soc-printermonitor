 ...
 */	
	...
	//intro page
	if ( $.query.get('ni') ){
		$("#list-home, #nav-home").remove();
		$("#printer-list ul li:first-child").css("display", "block"); 
	}	
 ...
 */
	...
	function showList(listName){
		...
		$(listName).slideDown().addClass('show').removeClass('hide');
	}
	...
	$('#printer-list h2.mlink').live('click', function() {
		...
		if ( status == 'none'){
			$('#printer-list ul').slideDown();
		} else {
			$('#printer-list ul').slideUp();
		}
